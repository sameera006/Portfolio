...
.panel[.panel-name[Thermometer]


]

.panel[.panel-name[Anemometer]

> measure wind speed

]

.panel[.panel-name[Psychrometer]

> to measure air humidity

]

.panel[.panel-name[GPS]

> Global Positioning System is a network of satellites and receiving devices used to determine the location of something on Earth

]

.panel[.panel-name[Transducers]

> It is an electronic device that converts energy from one form to another. 
]

.panel[.panel-name[Spectroradiometer]

> to measure the spectral reflectance characteristics of the material within the IFOV of the radiometer on the ground.
